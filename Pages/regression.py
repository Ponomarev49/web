...
def regression():
    ...
    op_system = {'Windows 11 Home': 0, 'Mac OS Big Sur': 1, 'DOS': 2, 'Mac OS Monterey': 3, 'Chrome': 4,
                 'Windows 10': 5,
    ...
    size = {39.62: 0, 33.78: 1, 35.56: 2, 96.52: 3, 100.63: 4, 40.89: 5, 35.81: 6, 40.64: 7, 39.01: 8, 34.54: 9,
            34.29: 10,
    ...
    if button_clicked:
        ...
        st.header("SVC RBF:")
        nn_pred = round(model.predict(data)[0])
